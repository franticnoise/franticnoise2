...
export function createYoutube(video_link, idtarget ) {
  const youtube =  `<iframe width="640" height="360" src="https://www.youtube.com/embed/${video_link}?controls=0"
    title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
    class="iframe_video" allowfullscreen></iframe>`
    return (document.getElementById(idtarget).innerHTML = youtube);
}

export function createSoundcloud(cloud_link, idtarget ) {
  const soundcloud =  `<iframe width="600px" height="300" scrolling="no" frameborder="no" allow="autoplay" class="iframe_souncloud" 
